...
class Util_HttpsqsClient
{
	...
	{
		$socket = fsockopen($this->_host, $this->_port, $errno, $errstr, 5);
		if (!$socket)
		{
			return false;
		}
	...
	{
		$socket = fsockopen($this->_host, $this->_port, $errno, $errstr, 1);
		if (!$socket)
		{
			return false;
		}
	...
	{
		$result = $this->http_post("/?auth=".$this->_auth."&charset=".$this->_charset."&name=".$queue_name."&opt=put", $queue_data);
	...
	{
		$result = $this->http_get("/?auth=".$this->_auth."&charset=".$this->_charset."&name=".$queue_name."&opt=get");
	...
	{
		$result = $this->http_get("/?auth=".$this->_auth."&charset=".$this->_charset."&name=".$queue_name."&opt=status");
				if ($result == false || $result["data"] == "HTTPSQS_ERROR" || $result["data"] == false) {
						return false;
				}
		return $result["data"];
	...
	{
		$result = $this->http_get("/?auth=".$this->_auth."&charset=".$this->_charset."&name=".$queue_name."&opt=view&pos=".$pos);
				if ($result == false || $result["data"] == "HTTPSQS_ERROR" || $result["data"] == false) {
						return false;
				}
		return $result["data"];
	...
	{
		$result = $this->http_get("/?auth=".$this->_auth."&charset=".$this->_charset."&name=".$queue_name."&opt=reset");
	...
	{
		$result = $this->http_get("/?auth=".$this->_auth."&charset=".$this->_charset."&name=".$queue_name."&opt=maxqueue&num=".$num);
	...
	{
		$result = $this->http_get("/?auth=".$this->_auth."&charset=".$this->_charset."&name=".$queue_name."&opt=status_json");
				if ($result == false || $result["data"] == "HTTPSQS_ERROR" || $result["data"] == false) {
						return false;
				}
		return $result["data"];
